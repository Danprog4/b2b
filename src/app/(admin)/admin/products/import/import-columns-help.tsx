...
const columnDescriptions = [
  ["sku", "Артикул товара. Можно оставить пустым: система назначит его автоматически. Если такой артикул уже есть, строка обновит найденный товар."],
  ...
  ["imageUrl", "Ссылка на изображение товара. Если указана, система попытается загрузить картинку и привязать ее к товару."],
  ...
  ["isActive", "Активность товара. Используйте true/false, 1/0, да/нет. Неактивный товар не показывается в каталоге."],
  ["isPopular", "Популярный товар. Используйте true/false, 1/0, да/нет. Влияет на сортировку по популярности."],
] as const;
