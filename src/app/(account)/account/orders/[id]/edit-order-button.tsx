            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-3 text-sm leading-6 text-slate-600">
                  По ТЗ покупатель не меняет состав уже созданного заказа.
                  Администратор может редактировать только заказ в статусе
                  «Принят», после чего формируется новый счет. Вы можете добавить
                  доступные позиции этого заказа в корзину по актуальным ценам и
                  оформить новый заказ. Если текущий заказ больше не нужен,
                  отмените его отдельной кнопкой на странице заказа.
                </p>
              </div>
              <button
