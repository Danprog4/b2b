...
export const banners = pgTable("banners", {
  id: uuid("id").defaultRandom().primaryKey(),
  title: varchar("title", { length: 255 }).notNull(),
  mobileTitle: varchar("mobile_title", { length: 255 }),
  ...
  mobileHeadline: varchar("mobile_headline", { length: 255 }),
  subheadline: text("subheadline"),
  mobileSubheadline: text("mobile_subheadline"),
  ctaText: varchar("cta_text", { length: 64 }),
  mobileCtaText: varchar("mobile_cta_text", { length: 64 }),
  href: text("href"),
  sortOrder: integer("sort_order").default(0).notNull(),
  isActive: boolean("is_active").default(true).notNull(),
